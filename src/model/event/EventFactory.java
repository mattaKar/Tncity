...
public class EventFactory {
    ...
    private static final Map<eventType, Integer> event_probabilities = Collections.unmodifiableMap(new HashMap<eventType, Integer>() {
        ...
        {
            this.put(eventType.NOTHING, 76);
            this.put(eventType.LUCKYYOU,3);
            this.put(eventType.RIOT, 20);
            this.put(eventType.METEOR, 1);
        }
    });
    ...
    public static Event generateEvent(GameBoard world) {
        ...
        switch (type) {
            case NOTHING:
                ...
                break;
            case LUCKYYOU:
                result = new LuckyYouEvent();
                break;
            case RIOT:
                result = new RiotEvent();
                break;
            case METEOR:
                result = new MeteorEvent(world);
                break;
            default:          	
                result = new NothingEvent();
                break;
