...
/**
 *  MessageView meant to be used in the event log to display wich random event or issues happened during the game
 */
public class MessagesView extends JPanel implements Observer {
    ...
    public MessagesView() {
        super();
        this.setBorder(BorderFactory.createTitledBorder("Event History"));
        this.message = new JTextArea(3, 110);
